...
export default async function(name){
 ...
 if(answers.db==="mongodb") execSync("npm install mongoose",{stdio:"inherit"})
 if(answers.db==="mssql") execSync("npm install mssql",{stdio:"inherit"})
 if(answers.db==="mysql") execSync("npm install mysql2 sequelize",{stdio:"inherit"})
